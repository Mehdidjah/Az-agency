    ...
    <div className="min-h-screen min-w-screen bg-white">
      ...
      <section className="relative bg-white px-4 sm:px-6 lg:px-10 py-6 flex flex-col items-center justify-center">
        <div className="relative w-full min-h-[820px] bg-navy-10" style={{ clipPath: "inset(0 round 28px)" }}>
          ...
          {/* Hero Content */}
          <div className="relative z-30 flex flex-col items-center gap-6 px-4 sm:px-10 lg:px-14 pt-16 max-w-5xl mx-auto">
            <div className="inline-flex items-center gap-3 bg-transparent backdrop-blur-sm rounded-full px-5 py-2.5 text-white animate-fade-up w-auto">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((item) => (
                  ...
                  >
                    <img
                      src={testimonialAvatar.src}
                      alt={testimonialAvatar.alt}
                      className="w-full h-full object-cover"
                    />
                  </div>
                ))}
            ...
            <div className="flex flex-col items-center translate-x-[10px]">
              <h1 className="font-jakarta font-bold text-[40px] sm:text-[52px] md:text-[64px] leading-[1.15] tracking-[-1.6px] text-center mt-2 animate-fade-up animation-delay-200">
                <span className="text-black-100">L'art de réaliser </span>
                <span className="text-gold-100">vos voyages</span>
              </h1>

              <p className="text-black-60 text-lg sm:text-[20px] md:text-[22px] leading-relaxed tracking-[-0.6px] max-w-[700px] text-center animate-fade-up animation-delay-300">
                Choisissez une offre du moment ou créez votre voyage sur mesure, on vous accompagne avant, pendant et après la réservation.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 animate-fade-up animation-delay-400">
                <a
                  href="#offres"
