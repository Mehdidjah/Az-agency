  ...
  return (
    <section id="faq" className="px-6 sm:px-10 lg:px-29 py-20 bg-white">
      ...
      >
        ...
        <div
          ref={containerRef}
          className={`w-full min-h-[520px] lg:min-h-0 bg-[#F9F9F9] rounded-2xl relative overflow-hidden select-none touch-none ${
            hasFaqs ? "lg:w-[520px]" : "max-w-[520px] mx-auto"
          }`}
